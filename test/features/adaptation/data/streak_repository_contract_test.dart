...
void runStreakRepositoryContractTests(
  ...
  group('round-trip', () {
    ...
    // The phase is the one enum-valued field in the store, so an encoding
    // that dropped or remapped a value would corrupt every stored record.
