...
**M9–M16 are not.** They are parallel peers, numbered by *recommended build order*
...
**Adding scope** to an open milestone is prohibited. If new work is discovered mid-milestone, open a new issue, assign it to the correct milestone (M9–M16, or a new one if it fits none), and continue. Never silently expand an existing issue.
...
| `epic:m16-menu-scanner` | Menu domain, prompt and parser, multi-page OCR reader, scanner screen, dish cards |
